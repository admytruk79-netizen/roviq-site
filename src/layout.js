...
function sharedBanner() {
  return `<section class="site-shared-banner" aria-label="ROVIQ automotive service coordination">
    <img id="siteGeneratedBanner" class="site-shared-banner-bg" src="/images/roviq-hero-forecourt.png?v=20260917c" alt="ROVIQ — Keeping You Moving Forward">
  </section>`;
}
...
.site-shared-banner-bg{display:block;width:100%;height:auto;aspect-ratio:16/9;object-fit:cover;object-position:center}
@media(max-width:560px){
  ...
  .site-shared-banner-bg{width:100%;height:auto;aspect-ratio:16/9;object-fit:contain;background:#07131f}
}
...
(function(){
  ...
  if(!img)return;
  Promise.all(['/banner-data/generated-00.txt','/banner-data/generated-01.txt','/banner-data/generated-02.txt'].map(function(u){return fetch(u+'?v=20260917').then(function(r){if(!r.ok)throw new Error('banner chunk');return r.text();});})).then(function(parts){img.src='data:image/webp;base64,'+parts.join('');}).catch(function(){});
})();
