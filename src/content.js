...
export const CONTENT_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "station.image_hero_secondary", label: "Secondary forecourt image", type: "image" },
      { key: "station.image_competitor_ref", label: "Reference composite (internal — contains real OKKO branding)", type: "image" },
      { key: "station.image_cafe", label: "Café/wine interior image", type: "image" },
      { key: "station.image_ev", label: "EV charging image", type: "image" },
      { key: "station.image_fuel", label: "Fuel/pricing detail image", type: "image" },
...
export const DEFAULT_CONTENT = {
  ...
  "roviq.revenue_stats":
    "Flat fee | Diagnostic visit, platform-set on every dispatch\nParts margin | On Platform-Priced shop jobs\nSubscription | Self-Priced shop lead-access tiers",
  "roviq.revenue_body":
    "Shops choose how they participate. Self-Priced shops keep full control of their own pricing and pay a flat monthly subscription for lead access instead of a per-job cut. Platform-Priced shops accept jobs at a Roviq-calculated price once a firm diagnosis exists and keep their labor revenue, while Roviq's margin comes from a markup on parts sourced through its vendor network. Underneath both sits one standardized, high-frequency transaction: a flat, platform-set diagnostic visit fee, paid at the point of dispatch regardless of what repair follows — the steady, predictable base the rest of the model builds on. Detailed pricing is available on request.",
  ...
  "roviq.why_heading": "Competitive moat",
  "roviq.why_pillars":
    "Asymmetric visibility — Every shop and technician sees a single referral at a time. Roviq sees the entire network — every booking, every wait time, every shop's actual reliability.\nNetwork density — Platform value increases with each new shop and technician added. A new entrant starting from zero must rebuild that density from scratch.\nData compounding — Over time, Roviq accumulates knowledge no outside party has: which shops are consistently fast, where demand clusters, which job types are most profitable to route.\nCustomer lock-in — Once customers are accustomed to the diagnostic-plus-loaner experience, the switching cost of finding a shop independently increases.\nShop dependency — As referral volume grows, participating shops come to rely on a meaningful share of business from the network.",
  ...
  "roviq.ask_stats":
    "Pre-seed | Current fundraising stage\nPhase D2 | Funds the full build-out through this phase\n12 mo | Runway covered by the round",
  "roviq.ask_body":
    "Roviq is raising a pre-seed round, funding the full project through Phase D2 — all five apps, AI diagnostic triage, the loaner fleet, marketing, founder runway, and a 12-month operating buffer, with the technical and business co-founders now leading execution alongside the founder. Full financials are available on request.",
  "roviq.ask_funds":
    "Product build-out — Customer, Diagnostic, Shop Partner, and Parts Vendor apps, including AI triage, pricing engine, and matching\nDiagnostic equipment — Tooling and labor-guide licensing\nLoaner fleet — Vehicle pool and insurance\nGrowth — Marketing plus partner and customer acquisition incentives\nFoundation — Founder runway, legal, cap table, and operating buffer",
