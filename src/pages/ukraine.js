...
<div class="uk-photo"><img src="${v.imagePath}" alt="${v.year} ${v.make} ${v.model}" loading="lazy"><div class="uk-badge">${v.mileageMi<10000?"ULTRA-LOW MILEAGE":"UNDER 60,000 MILES"}</div></div>
...
return `<style>
.uk-wrap{max-width:1220px;margin:0 auto;padding:20px 20px 56px;color:#dce4e9}
...
@keyframes ukFade{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:none}}
