...
const ECOSYSTEM = [
  {
    title: "ROVIQ Core",
    body: "The coordination layer connecting drivers, shops, parts, towing and service handoffs into one managed journey.",
...
<section class="hero home-hero">
  ...
  <div class="container">
    <div class="home-hero-copy">
      ...
      <p class="lead">ROVIQ connects drivers, service providers, physical infrastructure and local discovery through one coordinated ecosystem.</p>
      <div class="cta-row">
        <a href="/roviq" class="btn btn--gold">Explore Platform</a>
        <a href="/about" class="btn btn--outline">About ROVIQ</a>
      </div>
    </div>
  </div>
</section>
