...
<style>
  ...
  .station-visual--pair .media-full{height:100%;overflow:hidden}
  .station-visual--pair .media-full img{display:block;width:100%;height:100%;aspect-ratio:16/9;object-fit:cover}
...
<section class="section section--navy"><div class="container"><div class="station-feature-grid"><div class="station-feature-copy"><span class="eyebrow">Market entry</span><h2>${escapeHtml(c["station.portland_heading"])}</h2>${richText(c["station.portland_body"])}</div><div class="station-market-visual">${mediaFull("/images/1000055586(1).png","Oregon Roviq Station design concept")}<p class="station-market-note">Illustrative Roviq Station concept adapted for the Oregon market.</p></div></div></div></section>
