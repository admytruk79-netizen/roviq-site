...
export async function diagnosticsPage(env) {
  ...
  <div class="card metric"><b>${d.counts.available}</b><span>Available raw</span></div><div class="card metric"><b>${d.counts.publicReady||0}</b><span>Public-ready</span></div><div class="card metric"><b>${d.counts.withImages}</b><span>With image URL</span></div><div class="card metric"><b>${d.counts.sold}</b><span>Sold retained</span></div><div class="card metric"><b>${d.counts.unavailable}</b><span>Unavailable retained</span></div><div class="card metric"><b>${d.counts.sources}</b><span>Dealer adapters</span></div></div>
